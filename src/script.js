...
fontLoader.load(
    ...
    (font) => {
        ...
        // Material (already defined above)
        const material = new THREE.MeshMatcapMaterial({ matcap: matcapTexture })
        ...
        textGeometry1.translate(
            ...
            - (textGeometry1.boundingBox.max.z - 0.03) * 0.5
        )
        ...
        textGeometry2.translate(
            ...
            - (textGeometry2.boundingBox.max.z - 0.03) * 0.5
        )

        const text2 = new THREE.Mesh(textGeometry2, material)
        text2.position.y = -0.8 //  Moves the second line below the first
        scene.add(text2)
